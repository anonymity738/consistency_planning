...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps, returns=None, use_dropout=True, force_dropout=False):
        """
        ...
        if self.returns_condition:
            ...
            # emb = emb + self.returns_mlp(returns)
